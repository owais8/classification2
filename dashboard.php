...
include 'auth.php';
$conn = connectDB();
//get user email based on session_id
$id=$_SESSION['user_id'];
...
$query = "SELECT SUM(p.price) AS total_price
...
$query1 = "SELECT COUNT(p.price) AS total_user
FROM user_subscriptions us
INNER JOIN plans p ON us.plan_id = p.id";
...
// Get the total revenue
$totalUsers = $row2["total_users"];
$sql3 = "SELECT u.id, u.email,u.created
    ...
    <div class="flex flex-grow flex-col overflow-y-auto bg-cyan-700 pt-5 pb-4">
      ...
      <nav class="mt-5 flex flex-1 flex-col divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
        <div class="space-y-1 px-2">
          ...
          <a href="/classification/recent.php" class="text-cyan-100 hover:text-white hover:bg-cyan-600 group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md">
            <!-- Heroicon name: outline/credit-card -->
            <svg class="mr-4 h-6 w-6 flex-shrink-0 text-cyan-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" />
            </svg>
  ...
  <div class="flex flex-1 flex-col lg:pl-64">
          ...
          <div class="relative ml-3">
            <div>
              <button type="button" class="flex max-w-xs items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 lg:rounded-md lg:p-2 lg:hover:bg-gray-50" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                ...
                <span class="ml-3 hidden text-sm font-medium text-gray-700 lg:block"><span class="sr-only">Open user menu for </span><?php echo $row5['email']?></span>
    ...
    <main class="flex-1 pb-8">
      ...
      <div class="mt-8">
        <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <div class="text-lg font-medium text-gray-900">$<?php echo $totalRevenue?></div>
                      </dd>
                    </dl>
                  </div>
                </div>
            ...
            <div class="overflow-hidden rounded-lg bg-white shadow">
              <div class="p-5">
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      <dt class="truncate text-sm font-medium text-gray-500">Paid User</dt>
                      <dd>
                        <div class="text-lg font-medium text-gray-900"><?php echo $totalUser?></div>
                      </dd>
                    </dl>
                  </div>
                </div>
            ...
            <div class="overflow-hidden rounded-lg bg-white shadow">
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <div class="text-lg font-medium text-gray-900"><?php echo $totalUsers?></div>
                      </dd>
                    </dl>
                  </div>
                </div>
              ...
              <div class="bg-gray-50 px-5 py-3">
                <div class="text-sm">
                  <a href="/classification/recent.php" class="font-medium text-cyan-700 hover:text-cyan-900">View all</a>
                </div>
              </div>
            </div>
        ...
        <h2 class="mx-auto mt-8 max-w-6xl px-4 text-lg font-medium leading-6 text-gray-900 sm:px-6 lg:px-8">Recent signups</h2>
                  ...
                  <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr class="bg-white">
                      ...
                      <td class="whitespace-nowrap px-6 py-4 text-right text-sm text-gray-500">
                        <span class="font-medium text-gray-900"><?php echo $row5["email"]; ?></span>
